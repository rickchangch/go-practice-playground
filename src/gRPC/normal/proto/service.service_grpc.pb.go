...
type DemoServiceClient interface {
	Action(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *demoServiceClient) Action(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/servicepb.DemoService/Action", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDemoServiceServer) Action(context.Context, *Request) (*Response, error) {
...
func _DemoService_Action_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServiceServer).Action(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/servicepb.DemoService/Action",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServiceServer).Action(ctx, req.(*Request))
	}
...
var DemoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "servicepb.DemoService",
	HandlerType: (*DemoServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Action",
			Handler:    _DemoService_Action_Handler,
		},
	},
